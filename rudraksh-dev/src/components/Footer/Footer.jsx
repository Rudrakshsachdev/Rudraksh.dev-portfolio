...
const SOCIAL_LINKS = [
    { name: "GitHub", icon: <GithubIcon />, href: "https://github.com/Rudrakshsachdev" },
    { name: "LinkedIn", icon: <LinkedinIcon />, href: "https://www.linkedin.com/in/rudraksh-sachdeva-a35179326/" },
    { name: "Email", icon: <MailIcon />, href: "mailto:rudrakshsachdeva.dev@gmail.com" },
    { name: "WhatsApp", icon: <WhatsappIcon />, href: "https://wa.me/919354712773" },
];
                    ...
                    <div className={styles.linksRegion}>
                        ...
                        <div className={styles.contactMiniBox}>
                            ...
                            <a href="mailto:rudrakshsachdeva.dev@gmail.com" className={styles.emailCta}>
                                <span className={styles.miniIcon}><MailIcon /></span> rudrakshsachdeva.dev@gmail.com
                            </a>
                            <p className={styles.locationInfo}>
                                <span className={styles.miniIcon}><PinIcon /></span> New Delhi, India
                            </p>
